...
static const char PROPERTY_UICC_APPLICATIONS_ENABLE_STATE[4][55] = {
    "vendor.ril.sim.uicc.applications.enable.state",
    "vendor.ril.sim.uicc.applications.enable.state.2",
    "vendor.ril.sim.uicc.applications.enable.state.3",
    "vendor.ril.sim.uicc.applications.enable.state.4",
};
...
static const char PROPERTY_UICC_APPLICATIONS_ENABLE_SUPPORT[55] =
        "vendor.ril.sim.uicc.applications.enable.support";

static const char PROPERTY_SIM_CARD_ONOFF[35] = "ro.vendor.mtk_sim_card_onoff";

static const char PROPERTY_SIM_ONOFF_SUPPORT[35] = "vendor.ril.sim.onoff.support";
...
} UICC_APPLICATIONS_ENABLE_STATE;
...
extern void hash256(const char *input, char *output, int outputLength);
