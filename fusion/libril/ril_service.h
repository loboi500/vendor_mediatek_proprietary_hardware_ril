...
int iwlanRegistrationStateInd(unsigned int slotId, int indicationType,
        int token, RIL_Errno e, const void *response, size_t responseLen);

int nrSysInfoInd(unsigned int slotId, int indicationType,
        int token, RIL_Errno e, const void *response, size_t responseLen);
...
// MTK-END
// SIM RSU
int onRsuSimLockEvent(unsigned int slotId, int indicationType, int token, RIL_Errno e, const void *response,
        size_t responseLen);
...
int rttModifyRequestResponseResponse(unsigned int slotId, android::ClientId clientId,
        int responseType, int serial, RIL_Errno e,
        const void *response, size_t responselen);
int toggleRttAudioIndicationResponse(unsigned int slotId, android::ClientId clientId,
        int responseType, int serial, RIL_Errno e,
        const void *response, size_t responselen);
...
int registerCellQltyReportResponse(unsigned int slotId, android::ClientId clientId, int responseType,
        int serial, RIL_Errno e, const void *response, size_t responselen);
