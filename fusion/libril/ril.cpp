...
static void sendPendedUrcs(RIL_SOCKET_ID socket_id, android::ClientType clientType);
static void sendUrc(RIL_SOCKET_ID socket_id, AtResponseList** urcCached, android::ClientType clientType);
...
extern "C" void
RIL_initReadLockOwnerListMutex(void) {
...
#endif
{
    ...
    if (ret != 0 && unsolResponse == RIL_UNSOL_NITZ_TIME_RECEIVED) {
        ...
        memcpy(s_lastNITZTimeData[(unsigned int)soc_id], data, datalen);
    }
