...
#ifndef __RMM_EMBMS_REQUEST_HANDLER_H__
#define __RMM_EMBMS_REQUEST_HANDLER_H__
...
#undef LOG_TAG
#endif
#define LOG_TAG "RmmEmbmsReq"

class RmmEmbmsRequestHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmEmbmsRequestHandler);

    public:
        RmmEmbmsRequestHandler(int slot_id, int channel_id);
        virtual ~RmmEmbmsRequestHandler();
