...
#ifndef __RMM_EMBMS_URC_HANDLER_H__
#define __RMM_EMBMS_URC_HANDLER_H__
...
#undef LOG_TAG
#endif
#define LOG_TAG "RmmEmbmsUrc"
#define RIL_CMD_PROXY_EMBMS RIL_CMD_PROXY_6

class RmmEmbmsURCHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmEmbmsURCHandler);

    public:
        RmmEmbmsURCHandler(int slot_id, int channel_id);
        virtual ~RmmEmbmsURCHandler();
