...
#ifndef __RTM_EMBMS_AT_CONTROLLER_H__
#define __RTM_EMBMS_AT_CONTROLLER_H__
 ...
 * Class RtmEmbmsAtController
 *****************************************************************************/
class RtmEmbmsAtController : public RfxController {
    RFX_DECLARE_CLASS(RtmEmbmsAtController);  // Required: declare this class

public:
    RtmEmbmsAtController();

    virtual ~RtmEmbmsAtController();
...
private:
    // Private members
    Vector<RtmEmbmsSessionInfo*>* mSessionInfoList;
