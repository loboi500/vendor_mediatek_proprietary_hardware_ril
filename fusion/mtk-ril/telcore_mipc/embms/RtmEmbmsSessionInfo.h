...
#ifndef __RTM_EMBMS_SESSION_INFO_H__
#define __RTM_EMBMS_SESSION_INFO_H__
...
public:
    RtmEmbmsSessionInfo();
    virtual ~RtmEmbmsSessionInfo();
    void dump();
    void copy(RtmEmbmsSessionInfo& src);
public:
...
#endif /* __RTM_EMBMS_SESSION_INFO_H__ */
