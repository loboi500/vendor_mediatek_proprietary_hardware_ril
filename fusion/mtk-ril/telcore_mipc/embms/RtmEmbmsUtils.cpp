...
#define RFX_LOG_TAG "RtmEmbmsUtil"
...
RtmEmbmsUtils::RtmEmbmsUtils() {
}

RtmEmbmsUtils::~RtmEmbmsUtils() {
}

RtmEmbmsSessionInfo* RtmEmbmsUtils::findSessionByTransId(
                    Vector<RtmEmbmsSessionInfo*>* list, int trans_id, int* pIndex) {
    RtmEmbmsSessionInfo* pSessionInfo = NULL;
    *pIndex = -1;
...
RtmEmbmsSessionInfo* RtmEmbmsUtils::findSessionByTmgi(
                    Vector<RtmEmbmsSessionInfo*>* list, int tmgi_len, char* pTmgi, int* pIndex) {
    RtmEmbmsSessionInfo* pSessionInfo = NULL;
    *pIndex = -1;
...
void RtmEmbmsUtils::freeSessionList(Vector<RtmEmbmsSessionInfo*>* list) {
    if (list != NULL) {
        int size = list->size();
        for (int i = 0; i < size; i++) {
...
int RtmEmbmsUtils::getDefaultDataSlotId() {
...
bool RtmEmbmsUtils::revertTmgi(const uint8_t* input, char * output, int length) {
...
bool RtmEmbmsUtils::convertTmgi(const char * input, uint8_t* output) {
    int inputLen = 0, i = 0;
...
bool RtmEmbmsUtils::isEmbmsSupport() {
    bool ret = false;
...
bool RtmEmbmsUtils::isAtCmdEnableSupport() {
    bool ret = false;
    char prop[RFX_PROPERTY_VALUE_MAX] = {0};
...
char* RtmEmbmsUtils::addLogMask(int input) {
    char* out = NULL;
