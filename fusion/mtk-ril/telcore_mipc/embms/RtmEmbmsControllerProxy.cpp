...
#include "RtmEmbmsControllerProxy.h"
...
#define RFX_LOG_TAG "RTM_EMBMS_CON_PROXY"

#define RTM_EMBMS_PROPERTY_ENABLE "persist.vendor.sys.embms.enable"

/*****************************************************************************
 * Class RtmEmbmsControllerProxy
 *****************************************************************************/

RFX_IMPLEMENT_CLASS("RtmEmbmsControllerProxy", RtmEmbmsControllerProxy, RfxController);
// between RILJ and Rtm layer
...
RtmEmbmsControllerProxy::RtmEmbmsControllerProxy() :
...
void RtmEmbmsControllerProxy::onInit() {
    RfxController::onInit();  // Required: invoke super class implementation

    RtmEmbmsAtController *p;
    RFX_OBJ_CREATE(p, RtmEmbmsAtController, this);
    ...
    getStatusManager()->registerStatusChanged(RFX_STATUS_KEY_RADIO_STATE,
        RfxStatusChangeCallback(this, &RtmEmbmsControllerProxy::onRadioStateChanged));
}

void RtmEmbmsControllerProxy::onDeinit() {
    logD(RFX_LOG_TAG, "onDeinit");
    RfxController::onDeinit();
}

void RtmEmbmsControllerProxy::onRadioStateChanged(RfxStatusKeyEnum key,
    ...
    if (radioState == RADIO_STATE_ON) {
        rfx_property_get(RTM_EMBMS_PROPERTY_ENABLE, defaultData, "");
