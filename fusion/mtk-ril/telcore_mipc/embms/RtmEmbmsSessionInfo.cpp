...
#define RFX_LOG_TAG "RTM_EMBMS_INFO"

/*****************************************************************************
 * Class RpDataConnectionInfo
 *****************************************************************************/

RtmEmbmsSessionInfo::RtmEmbmsSessionInfo() :
    mTransId(-1),
    mTmgiLen(0),
    mTmgi{0},
    mSaiCount(0),
...
void RtmEmbmsSessionInfo::copy(RtmEmbmsSessionInfo& src) {
