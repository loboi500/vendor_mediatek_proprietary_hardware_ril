...
using namespace std;
/*****************************************************************************
 * Class RtmImsConferenceHandler
 *****************************************************************************/

class RtmImsConferenceHandler {
public:
    RtmImsConferenceHandler(int slot);
    ~RtmImsConferenceHandler();
...
private:
    RtmImsConferenceCallMessageHandler* parseXmlPackage(string data);
    void restoreParticipantsAddressByLocalCache();
    void restoreUnknowParticipants(vector<string> restoreUnknowCandidates);
    void setupHost(RtmImsConferenceCallMessageHandler* xmlData);
