...
protected:
    ...
    void preCheckIfNeedDisableIms(const sp<RfxMessage>& message);
    ...
    void handleDeactivateDataRequest(const sp<RfxMessage>& message);
    void handleSetPreferredDataModem(const sp<RfxMessage>& message);
    void onImsConfirmed(const sp<RfxMessage> message);
    void requestResumeIms(const sp<RfxMessage> message);
