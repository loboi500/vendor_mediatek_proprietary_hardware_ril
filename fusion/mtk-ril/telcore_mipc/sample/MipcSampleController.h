...
#ifndef __RFX_MIPC_SAMPLE_CONTROLLER_H__
#define __RFX_MIPC_SAMPLE_CONTROLLER_H__
 ...
 * Class RfxController
 *****************************************************************************/
class MipcSampleController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(MipcSampleController);

public:
    MipcSampleController();
    virtual ~MipcSampleController();
