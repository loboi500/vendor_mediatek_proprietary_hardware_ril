...
#define __RIL_CLIENT_COMMAND_H__
    ...
    {RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_RAN, dispatchString, responseVoid },
    ...
    {RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP, dispatchInts, responseVoid },
    {RIL_REQUEST_GET_ALLOWED_NETWORK_TYPES_BITMAP, dispatchVoid, responseInts },
    {RIL_REQUEST_GET_NEIGHBORING_CELL_IDS, dispatchVoid, responseCellList },
    {RIL_REQUEST_SET_LOCATION_UPDATES, dispatchInts, responseVoid },
    {RIL_REQUEST_GET_BARRINGINFO, dispatchVoid, responseInts},
    ...
    {RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE, dispatchCdmaSms, responseSMS },
    ...
    {RIL_REQUEST_ENTER_SIM_DEPERSONALIZATION, dispatchStrings, responseInts },
    ...
    {RIL_REQUEST_ARE_UICC_APPLICATIONS_ENABLED, dispatchVoid, responseInts },
    ...
    {RIL_REQUEST_SET_DISABLE_2G, dispatchInts, responseVoid },
    {RIL_REQUEST_GET_DISABLE_2G, dispatchVoid, responseInts },
    ...
    {RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS, dispatchVoid, responseGetSystemSelectionChannels},
    ...
    /// M: WIFI Relay @{
    {RIL_REQUEST_SEND_WIFI_ENABLED, dispatchStrings, responseVoid },
    {RIL_REQUEST_SEND_WIFI_ASSOCIATED, dispatchStrings, responseVoid },
    {RIL_REQUEST_SEND_WIFI_IP_ADDRESS, dispatchStrings, responseVoid },
    /// @}
