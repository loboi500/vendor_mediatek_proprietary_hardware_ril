...
void RpC2kSimController::handleEnterSimDepersonalizationReq(
        const sp<RfxMessage>& message) {
    RLOGD("[RpC2kSimController] handleEnterSimDepersonalizationReq (slot %d)", getSlotId());

    sendReq(message);
}

void RpC2kSimController::handleEnterSimDepersonalizationRsp(
        const sp<RfxMessage>& message) {
    RLOGD("[RpC2kSimController] handleEnterSimDepersonalizationRsp (slot %d)", getSlotId());
...
void RpC2kSimController::handleEnableUiccApplicationsReq(
        const sp<RfxMessage>& message) {
    RLOGD("[RpC2kSimController] handleEnableUiccApplicationsReq (slot %d)", getSlotId());

    sendReq(message);
}

void RpC2kSimController::handleEnableUiccApplicationsRsp(
        const sp<RfxMessage>& message) {
    RLOGD("[RpC2kSimController] handleEnableUiccApplicationsRsp (slot %d)", getSlotId());

    sendRsp(message);
}

void RpC2kSimController::handleAreUiccApplicationsEnabledReq(
        const sp<RfxMessage>& message) {
    RLOGD("[RpC2kSimController] handleAreUiccApplicationsEnabledReq (slot %d)", getSlotId());

    sendReq(message);
}

void RpC2kSimController::handleAreUiccApplicationsEnabledRsp(
        const sp<RfxMessage>& message) {
    RLOGD("[RpC2kSimController] handleAreUiccApplicationsEnabledRsp (slot %d)", getSlotId());
