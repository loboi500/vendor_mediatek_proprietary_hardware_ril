...
private:
    ...
    void handleEnterSimDepersonalizationReq(const sp<RfxMessage>& message);
    void handleEnterSimDepersonalizationRsp(const sp<RfxMessage>& message);

    void handleEnableUiccApplicationsReq(const sp<RfxMessage>& message);
    void handleEnableUiccApplicationsRsp(const sp<RfxMessage>& message);

    void handleUiccApplicationsEnablementChanged(const sp<RfxMessage>& message);

    bool isEnableUiccApplicationsSupported();
    bool isEnableUiccApplicationsProcessing();

    void handleAreUiccApplicationsEnabledReq(const sp<RfxMessage>& message);
    void handleAreUiccApplicationsEnabledRsp(const sp<RfxMessage>& message);

    bool handleFakeEnableUiccApplicationsRsp(const sp<RfxMessage>& message);
    bool handleFakeAreUiccApplicationsEnabledRsp(const sp<RfxMessage>& message);

    void handleIccidChanged(const sp<RfxMessage>& message);
...
private:
    ...
    int mUiccApplicationEnable;
    sp<RfxMessage> mCacheUiccEnableMsg;
};
