...
void RpGsmSimController::handleEnterSimDepersonalizationReq(
        const sp<RfxMessage>& message) {
    RLOGD("[RpGsmSimController] handleEnterSimDepersonalizationReq (slot %d)", getSlotId());
    sendReq(message);
}

void RpGsmSimController::handleEnterSimDepersonalizationRsp(
        const sp<RfxMessage>& message) {
    RLOGD("[RpGsmSimController] handleEnterSimDepersonalizationRsp (slot %d)", getSlotId());
    sendRsp(message);
}

void RpGsmSimController::handleEnableUiccApplicationsReq(
        const sp<RfxMessage>& message) {
    RLOGD("[RpGsmSimController] handleEnableUiccApplicationsReq (slot %d)", getSlotId());

    sendReq(message);
}

void RpGsmSimController::handleEnableUiccApplicationsRsp(
        const sp<RfxMessage>& message) {
    RLOGD("[RpGsmSimController] handleEnableUiccApplicationsRsp (slot %d)", getSlotId());

    sendRsp(message);
}

void RpGsmSimController::handleAreUiccApplicationsEnabledReq(
        const sp<RfxMessage>& message) {
    RLOGD("[RpGsmSimController] handleAreUiccApplicationsEnabledReq (slot %d)", getSlotId());

    sendReq(message);
}

void RpGsmSimController::handleAreUiccApplicationsEnabledRsp(
        const sp<RfxMessage>& message) {
    RLOGD("[RpGsmSimController] handleAreUiccApplicationsEnabledRsp (slot %d)", getSlotId());
