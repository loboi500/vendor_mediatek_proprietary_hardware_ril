...
const char PROPERTY_UICC_APPLICATIONS_ENABLE_STATE[4][50] = {
...
const char noSim[4] = {"N/A"};

#define PROPERTY_UICC_APPLICATIONS_ENABLE_SUPPORT "vendor.ril.sim.uicc.applications.enable.support"
...
protected:
    ...
    void sendIccidUrc(const char* iccid);
};
